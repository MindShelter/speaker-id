...
from src.models.llm_clients.local_llm import LocalLLMClient
from src.models.llm_clients.prompts.single_prompt import single_prompt
from src.models.nlp.init_model import init_model

app = typer.Typer(add_completion=False, help="Speaker prediction with Local LLM")
...
def build_config(
    *,
    ...
    llm = LocalLLMClient(config=LocalLLMConfig.from_env())
